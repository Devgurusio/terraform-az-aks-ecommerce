...
variable "default_node_pool_agents_availability_zones" {
  type        = list(string)
...
variable "secondary_node_pool_max_pods" {
  type        = number
  description = "(Optional) The maximum number of pods that can run on each agent. Changing this forces a new resource to be created."
  default     = 50
}
...
variable "secondary_node_pool_name" {
  type        = string
  description = "The secondary Azure AKS agentpool (nodepool) name."
  default     = "secondary"
}
...
variable "secondary_node_pool_size" {
  type        = string
  description = "The default virtual machine size for the Kubernetes agents"
  default     = "Standard_D2s_v3"
}
...
variable "secondary_node_pool_enable_auto_scaling" {
  type        = bool
  description = "Enable node pool autoscaling"
  default     = true
}
...
variable "secondary_node_pool_enable_host_encryption" {
  type        = bool
  description = "Enable Host Secondary for default node pool. Encryption at host feature must be enabled on the subscription: https://docs.microsoft.com/azure/virtual-machines/linux/disks-enable-host-based-encryption-cli"
  default     = false
}
...
variable "secondary_node_pool_enable_node_public_ip" {
  type        = bool
  description = "(Optional) Should nodes in this Node Pool have a Public IP Address? Defaults to false."
  default     = false
}
...
variable "secondary_node_pool_os_disk_size_gb" {
  type        = number
  description = "Disk size of nodes in GBs."
  default     = 30
}
...
variable "secondary_node_pool_os_disk_type" {
  type        = string
  description = "The type of disk which should be used for the Operating System. Possible values are `Ephemeral` and `Managed`. Defaults to `Managed`. Changing this forces a new resource to be created."
  default     = "Managed"
  nullable    = false
...
variable "secondary_node_pool_ultra_ssd_enabled" {
  type        = bool
  description = "(Optional) Used to specify whether the UltraSSD is enabled in the Secondary Node Pool. Defaults to false."
  default     = false
}
...
variable "secondary_node_pool_priority" {
  description = "(Optional) The priority for Spot nodes in the Node Pool. Possible values are Spot and Regular. Defaults to Spot."
  type        = string
  default     = "Spot"
}

variable "secondary_node_pool_eviction_policy" {
  description = "(Optional) The eviction policy for Spot nodes in the Node Pool. Possible values are Delete and Deallocate. Defaults to Delete."
  type        = string
  default     = "Delete"
}

variable "secondary_node_pool_spot_max_price" {
  description = "(Optional) The maximum price per hour that you are willing to pay for Spot nodes. Changing this forces a new resource to be created."
  type        = number
  default     = 0.5
}

variable "rbac_enabled" {
  description = "Enable or Disable RBAC. Defaults to true."
  type        = bool
  default     = true
}

variable "rbac_managed" {
  description = "Enable or Disable RBAC Managed. Defaults to true."
  type        = bool
  default     = true
}
...
variable "acr_admin_enabled" {
  type        = bool
  description = "The admin user enabled status of the container registry"
  default     = false
}
...
variable "acr_retention_days" {
  type        = number
  description = "The number of days to retain the logs for"
  default     = 7
}

variable "acr_retention_enabled" {
  type        = bool
  description = "The retention policy enabled status"
  default     = true
}

variable "acr_anonymous_pull_enabled" {
  type        = bool
  description = "The anonymous pull enabled status"
  default     = false
}
...
variable "acr_trust_policy_enabled" {
  description = "The trust policy enabled status"
  type        = bool
  default     = true
}
